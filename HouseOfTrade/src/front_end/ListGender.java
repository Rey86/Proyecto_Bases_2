...
public class ListGender extends javax.swing.JDialog {
    ...
    public void GenderList() throws SQLException{
        ResultSet r = logic_connection.DataBaseConnection.getGenders();
        DefaultTableModel dtb = (DefaultTableModel) jTableGenders.getModel();
        while(r.next()){
            dtb.addRow(new Object[]{r.getInt("ID_GENDER"), r.getString("NAME")});
        }
    }
    ...
    private void jButtonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditActionPerformed
        ...
        if(current_row != -1){
            InsertGender dialog = new InsertGender(new javax.swing.JFrame(), true, (Integer) jTableGenders.getValueAt(current_row, 0));
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        ...
        if(current_row != -1){
            try{
                logic_connection.DataBaseConnection.deleteGender((Integer) jTableGenders.getValueAt(current_row, 0));
                GenderCleanList();
                GenderList();
            }
            catch (SQLException e){
