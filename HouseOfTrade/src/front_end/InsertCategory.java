...
public class InsertCategory extends javax.swing.JDialog {
    ...
    public InsertCategory(java.awt.Frame parent, boolean modal, Integer id_category) {
        super(parent, modal);
    ...
    public void initial(){
        try{
            if(id_category > 0){
                ResultSet r = logic_connection.DataBaseConnection.getCategory(id_category);
                if(r.next()) {
                    jLabelID.setText(String.valueOf(r.getInt("ID_CATEGORY")));
    ...
    private void jButtonAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAcceptActionPerformed
        if (!jTextFieldName.getText().equals("")){
            try{
                if(id_category > 0){
                    logic_connection.DataBaseConnection.setCategory(Integer.valueOf(jLabelID.getText()), jTextFieldName.getText());
                    dispose();
                }
                else{
                    logic_connection.DataBaseConnection.insertCategory(jTextFieldName.getText());
                    dispose();
                }
            }
            catch (SQLException e){
                ...
                JOptionPane.showMessageDialog(this, "The ID Category box is empty", "Watch out", JOptionPane.ERROR_MESSAGE);
            }
        } else {
