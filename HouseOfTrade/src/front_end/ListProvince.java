...
public class ListProvince extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTableProvinces.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "ID Country", "Country Name"
            }
        ) {
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        ...
        if(current_row != -1){
            try{
                logic_connection.DataBaseConnection.deleteProvince((Integer) jTableProvinces.getValueAt(current_row, 0));
                ProvinceCleanList();
                ProvinceList();
            }
            catch (SQLException e){
    ...
    private void jButtonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditActionPerformed
        Integer current_row = jTableProvinces.getSelectedRow();
        if(current_row != -1){
            InsertProvince dialog = new InsertProvince(new javax.swing.JFrame(), true, (Integer) jTableProvinces.getValueAt(current_row, 0));
