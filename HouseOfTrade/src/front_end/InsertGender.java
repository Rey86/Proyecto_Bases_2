...
public class InsertGender extends javax.swing.JDialog {
    ...
    public void initial(){
        try{
            if(id_gender > 0){
                ResultSet r = logic_connection.DataBaseConnection.getGender(id_gender);
                if(r.next()) {
    ...
    private void jButtonAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAcceptActionPerformed
        if (!jTextFieldName.getText().equals("")){
            try{
                if(id_gender > 0){
                    logic_connection.DataBaseConnection.setGender(Integer.valueOf(jLabelID.getText()), jTextFieldName.getText());
                    dispose();
                }
                else{
                    logic_connection.DataBaseConnection.insertGender(jTextFieldName.getText());
                    dispose();
                }
            }
            catch (SQLException e){
                ...
                JOptionPane.showMessageDialog(this, "The ID Gender box is empty", "Watch out", JOptionPane.ERROR_MESSAGE);
            }
        } else {
